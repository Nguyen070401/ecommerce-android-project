...
import { useSafeAreaInsets, SafeAreaProvider } from "react-native-safe-area-context"; // Import SafeAreaProvider
...
const FilterView = () => {
  ...
  return (
    ...
    <View style={{paddingHorizontal: 5, gap: 20}}>
        ...
        >
            <Text
            style={{flex: 1, fontSize: 18, fontWeight: "700", color: theme.colors.text,}}
            >Filters</Text>
            <TouchableOpacity>
                <Text>Reset</Text>
            </TouchableOpacity>
