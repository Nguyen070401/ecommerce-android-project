          ...
          <View style={{padding:16, flex: 1}}>
            ...
            <View style={{
              ...
              numberOfLines={9}>
                ...
                It is known for its vibrant culture, cutting-edge technology, 
                and delicious cuisine. The city is home to some of the world's 
                busiest train stations, including Shinjuku Station and Tokyo Station. 
                Visitors can explore the many museums and galleries, such as the Tokyo
                National Museum and the Mori Art Museum, take a stroll where visitors can find luxury brands and trendy boutiques. 
              </Text>
            </View>

          <View style={{ flex: 1 }} />
          <View style={{ flexDirection: "row", alignItems: "center", position: 'absolute', bottom: 18, left: 14, right: 14 }}>
            <View style={{ flex: 1 }}>
              <Text
